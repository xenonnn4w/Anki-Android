...
class WidgetPreferences(context: Context) {
    ...
    fun getSelectedDeckIdsFromPreferencesCardAnalysisExtraWidgetData(appWidgetId: Int): LongArray {
    ...
    fun saveSelectedDecksCardAnalysisExtraWidgetData(appWidgetId: Int, selectedDecks: List<String>) {
        cardAnalysisSharedPreferences.edit {
