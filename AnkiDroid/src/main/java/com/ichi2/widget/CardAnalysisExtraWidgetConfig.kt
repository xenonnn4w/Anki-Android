...
/**
 * Activity for configuring the Card Analysis Extra Widget.
 * This activity allows the user to select one deck from deck selection dialog to be displayed in the widget.
 */
class CardAnalysisExtraWidgetConfig : FragmentActivity(), DeckSelectionListener {

    private var appWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID
    private lateinit var deckAdapter: WidgetConfigScreenAdapter
    private lateinit var CardAnalysisExtraWidgetPreferences: WidgetPreferences

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.widget_deck_picker_config)

        CardAnalysisExtraWidgetPreferences = WidgetPreferences(this)
        ...
        findViewById<RecyclerView>(R.id.recyclerViewSelectedDecks).apply {
            ...
            adapter = this@CardAnalysisExtraWidgetConfig.deckAdapter
        }
        ...
        findViewById<Button>(R.id.done_button).setOnClickListener {
            ...
            sendBroadcast(Intent(this, CardAnalysisExtraWidget::class.java))
    ...
    private fun saveSelectedDecksToPreferences() {
        ...
        val updateIntent = Intent(this, CardAnalysisExtraWidget::class.java).apply {
            ...
            putExtra("card_analysis_extra_widget_selected_deck_ids", selectedDecks.map { it.toLong() }.toLongArray())
        }
